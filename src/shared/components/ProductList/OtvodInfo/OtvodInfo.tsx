          ...
          },
          {
            ...
            subspeciesContent: (
              <div className={styles.productInfoContentLeft}>
                ...
                <p>*Задвижки под разные типы приводов изготавливаются по согласованию с заказчиком (при несоответствии максимального момента электропривода номинальному моменту закрытия задвижки.</p>
              </div>
            ),
          },
        ],
